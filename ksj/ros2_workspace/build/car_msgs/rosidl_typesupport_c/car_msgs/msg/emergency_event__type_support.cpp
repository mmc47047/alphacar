...
static const _EmergencyEvent_type_support_symbol_names_t _EmergencyEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_msgs, msg, EmergencyEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_msgs, msg, EmergencyEvent)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, car_msgs, msg, EmergencyEvent)() {
  return &::car_msgs::msg::rosidl_typesupport_c::EmergencyEvent_message_type_support_handle;
}
