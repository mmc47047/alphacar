...
#include "car_msgs/msg/detail/emergency_event__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = car_msgs::msg::EmergencyEvent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const car_msgs::msg::EmergencyEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_msgs::msg::EmergencyEvent *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EmergencyEvent__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const car_msgs::msg::EmergencyEvent *>(
...
static size_t _EmergencyEvent__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_EmergencyEvent(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EmergencyEvent__callbacks = {
  "car_msgs::msg",
  "EmergencyEvent",
...
static rosidl_message_type_support_t _EmergencyEvent__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EmergencyEvent__callbacks,
...
{
  return &car_msgs::msg::typesupport_fastrtps_cpp::_EmergencyEvent__handle;
}
